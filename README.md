...
**Fase 1: estrutura inicial e documentação.** Este repositório ainda não contém uma aplicação executável. A migração do projeto Visitas será feita em entregas progressivas, com revisão e validação de cada módulo.
